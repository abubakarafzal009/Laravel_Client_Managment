...
<div class="card">
        ...
        <form class="form form-vertical" method="POST" action="{{ route('CourseDetail.update',$course->id) }}">
            @csrf
            @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8" id="wrap-indirizzo_carico">
                            <input name="course" type="text" class="form-control input-sm" value="{{$course->course_name}}"
...
<a href="javascript:void(0);" class="btn btn-primery remove-div" style="background-color: red; color:white;" title="Remove Module"> <i class="fa fa-minus" aria-hidden="true"></i></a>
 ...
 <div class="col-sm-4 pull-right">
   ...
   <div  id="wrap-indirizzo_carico">
       <input name="name[]" type="text" class="form-control input-sm" value="{{$mod->Module_Name}}"
   ...
   <div class="col-sm-4 pull-right">
       ...
       <select class="form-control" name="level[]" id="basicSelect">
                                   <option @if($mod->Level=="level 1") selected @endif value="level 1" >Level 1</option>
                                   <option @if($mod->Level=="level 2") selected @endif value="level 2">Level 2</option>
                                   <option @if($mod->Level=="level 3") selected @endif value="level 3">Level 3</option>
                                   <option @if($mod->Level=="level 4") selected @endif value="level 4">Level 4</option>
